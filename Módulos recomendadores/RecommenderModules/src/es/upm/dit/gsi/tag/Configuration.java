...
public class Configuration {
	...
	public static String url = "jdbc:mysql://localhost:3306/tagmodule";
	public static String driver = "com.mysql.jdbc.Driver";
	public static String servername = "localhost";
	public static String dbname = "tagmodule";
	public static String user = "tagu";
	public static String pass = "tagp";
	
	private static final Logger log = Logger.getLogger("tag.Configuration");
