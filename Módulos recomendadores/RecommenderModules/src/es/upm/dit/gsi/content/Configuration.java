...
public class Configuration {
	...
	public static String url = "jdbc:mysql://localhost:3306/contentmodule";
	public static String driver = "com.mysql.jdbc.Driver";
	public static String servername = "localhost";
	public static String dbname = "contentmodule";
	public static String user = "cntu";
	public static String pass = "cntp";
	
	private static final Logger log = Logger.getLogger("content.Configuration");
