...
public class Configuration {
	...
	public static String dbname = "mahout";
	public static String user = "mahoutu";
	public static String pass = "mahoutp";
	...
	/**
	 * Crea una configuración para el objeto dataSource y una conexión
	 ...
	 * @param pass
	 */
	/*private Configuration(String dbname, String user, String pass, String url){
		dataSource = new MysqlDataSource();
		dataSource.setServerName(servername);
		dataSource.setDatabaseName(dbname);
		dataSource.setUser(user);
